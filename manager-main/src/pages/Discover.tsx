...
export default function Discover() {
  ...
  return (
    <div className="h-full w-full vibrant-gradient-1 relative">
      <header className="absolute top-0 left-0 w-full pt-4 pb-8 px-6 z-50 bg-gradient-to-b from-black/60 to-transparent pointer-events-none">
        <div className="flex justify-between items-start pointer-events-auto">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-glow">发现创意灵感</h1>
            <div className="flex items-center gap-2 mt-1">
              <span className="text-xs font-medium text-white/70">10月24日, 星期一</span>
      ...
      <div className="absolute bottom-32 left-0 w-full px-6 flex flex-col gap-6">
        <div className="flex items-end justify-between">
          <div className="flex-1">
            <span className="inline-block px-3 py-1 rounded-full bg-white/20 backdrop-blur-md text-[10px] font-bold uppercase tracking-widest border border-white/30 mb-3">{tag}</span>
            <h2 className="text-4xl font-bold leading-tight mb-4 drop-shadow-xl">{title}</h2>
            <div className="flex items-center gap-4">
              ...
              {rating && (
                <>
                  ...
                  <div className="flex items-center gap-1 glass-card px-3 py-1.5 rounded-full">
